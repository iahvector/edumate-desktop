/********************************************************************************
** Form generated from reading UI file 'edumdesktop.ui'
**
** Created: Thu Jul 5 01:38:25 2012
**      by: Qt User Interface Compiler version 4.7.4
**
** WARNING! All changes made in this file will be lost when recompiling UI file!
********************************************************************************/

#ifndef UI_EDUMDESKTOP_H
#define UI_EDUMDESKTOP_H
...
public:
    ...
    void setupUi(QMainWindow *eduMDesktop)
    {
        if (eduMDesktop->objectName().isEmpty())
            eduMDesktop->setObjectName(QString::fromUtf8("eduMDesktop"));
        eduMDesktop->resize(800, 480);
        QSizePolicy sizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(eduMDesktop->sizePolicy().hasHeightForWidth());
        eduMDesktop->setSizePolicy(sizePolicy);
        eduMDesktop->setMinimumSize(QSize(800, 480));
        eduMDesktop->setMaximumSize(QSize(800, 480));
        centralWidget = new QWidget(eduMDesktop);
        ...
        eduMDesktop->setCentralWidget(centralWidget);

        retranslateUi(eduMDesktop);

        QMetaObject::connectSlotsByName(eduMDesktop);
    } // setupUi

    void retranslateUi(QMainWindow *eduMDesktop)
    {
        eduMDesktop->setWindowTitle(QApplication::translate("eduMDesktop", "eduMDesktop", 0, QApplication::UnicodeUTF8));
        categoriesTitle_label->setText(QApplication::translate("eduMDesktop", "Categories", 0, QApplication::UnicodeUTF8));
...
namespace Ui {
    class eduMDesktop: public Ui_eduMDesktop {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_EDUMDESKTOP_H
